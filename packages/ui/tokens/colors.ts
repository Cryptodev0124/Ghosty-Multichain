...
export const lightColors = {
  ...baseColors,
  ...additionalColors,
  secondary: 'rgb(106, 255, 255)',
  secondary80: '#7645D980',
  background: '#FAF9FA',
  backgroundDisabled: '#E9EAEB',
  backgroundAlt: 'rgb(15, 20, 20)',
  backgroundAlt2: 'rgba(255, 255, 255, 0.7)',
  cardBorder: '1px solid rgb(255, 127, 0)',
  contrast: '#191326',
  dropdown: '#354743',
  dropdownDeep: '#354743',
  ...
  textSubtle: '#FFFFFF',
  disabled: '#E9EAEB',
  gradientBubblegum: 'linear-gradient(139.73deg, rgb(255, 127, 0) 0%, rgb(102, 48, 1) 0%, rgb(0, 0, 0) 98%)',
  gradientInverseBubblegum: 'linear-gradient(139.73deg, #F3EFFF 0%, #E5FDFF 100%)',
  gradientCardHeader: 'transparent',
