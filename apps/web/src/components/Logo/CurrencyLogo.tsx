...
export default function CurrencyLogo({
  ...
  console.log(currency.symbol === 'GHOSTTY')
  return <StyledLogo size={size} srcs={currency.symbol === 'GHOSTTY' ? [(currency as WrappedTokenInfo).logoURI] : srcs} alt={`${currency?.symbol ?? 'token'} logo`} style={style} />
}
