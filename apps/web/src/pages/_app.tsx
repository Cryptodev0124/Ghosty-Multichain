  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Cheaper and faster than Uniswap? Discover GhostyTrade, the leading DEX on BNB Smart Chain (BSC) and Ethereum with the best farms in DeFi and a lottery for GHOSTTY."
        />
