...
export const DEFAULT_META: PageMeta = {
  title: 'GhostyTrade',
  description:
    'The most popular AMM on BSC and Ethereum by user count! Earn GHOSTTY through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by GhostyTrade), NFTs, and more, on a platform you can trust.',
